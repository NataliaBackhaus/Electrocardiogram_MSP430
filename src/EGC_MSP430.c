...
int main(void){
    ...
    while(TRUE){
         ADC12CTL0 |= ADC12ENC; //Habilitar a cada convers�o
...
void tb0_config(void){
    ...
    P4DIR |= BIT0;              //P4.0 como sa�da
    P4SEL |= BIT0;              //P4.0 sa�da alternativa
    PMAPKEYID = 0X02D52;        //Liberar mapeamento
    P4MAP0 = PM_TB0CCR1A;       //TB0.1 sa� por P4.0
}
...
// Buffer circular para armazenas os 10 �ltimos valores
void buffer_func(int valor){
